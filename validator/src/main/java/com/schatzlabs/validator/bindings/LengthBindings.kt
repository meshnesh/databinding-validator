 ...
 */
@BindingAdapter(
    value = ["validateMinLength", "validateMinLengthMessage", "validateLengthAutoDismiss"],
    requireAll = false
)
 ...
 */
@BindingAdapter(
    value = ["validateMaxLength", "validateMaxLengthMessage", "validateAutoDismiss"],
    requireAll = false
)
 ...
 */
@BindingAdapter(
    value = ["validateEmpty", "validateEmptyMessage", "validateLengthAutoDismiss"],
    requireAll = false
)
